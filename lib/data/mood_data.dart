...
class MoodData {
  ...
  static final List<MoodEntry> moodEntries = [
    ...
    MoodEntry(id: 'm15', mood: 5, note: 'Best day ever — landed a new project.', tags: ['Work', 'Grateful'], timestamp: _daysAgo(12, hour: 18)),
  ...
  static final List<JournalEntry> journalEntries = [
    ...
    JournalEntry(id: 'j2', title: 'Weekly Reflection', content: 'This week was intense at work but I managed to keep balanced. Landing the new project was incredible — hard work pays off!', tags: ['Work', 'Grateful'], timestamp: _daysAgo(3, hour: 21)),
